...
**老张** 的看法是：**老王** 的总体观念没错，因为他自己此前也是这么认为的。但自去年下半年Claude Code在AI编程上的表现实在震撼，他的看法有所转变。老张认为，世界是不断发展变化的，0-1架构并不意味着无法突破，它同样可以在高层表达出类人的思维与情绪。人的大脑本质上也是电信号的复杂组合，只不过其规模和复杂度远超当前计算系统。如今的Agentic AI及Harness工程架构（如任务编排、上下文组织、状态管理、工具链整合等），正在从工具逐步向“类认知系统”演进，并在一定程度上表现出类人认知特征。
...
这一想法与老子相似：真正的“道”难以用语言表达，能表达出来的就不是那个“道”了。人类最高级的地方恰恰在于语法无法言说的东西，需要体会，且因人而异。维特根斯坦也有类似观点——语言即世界，凡能用语言说清楚的就能说清楚，说不清楚的那个真实世界我们无法理解。
...
**老张** 强调：世界是发展的，无限逼近表达也是可行的，行业自循环是必经阶段。
